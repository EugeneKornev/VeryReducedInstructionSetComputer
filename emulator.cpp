...
namespace Emulator {
  ...
  struct EmulatorState {
    ...
    EmulatorState() {
        _registers = std::vector<int>(regs_size);
        _mem = std::vector<int>(mem_size);
    }
  ...
  public:
    ...
    void increment(EmulatorState& emul) {
        emul._pc++;
    }
  };
  ...
  class ArithmeticInstructionReg : public RegisterInstruction {
    ...
    public:
      ...
      ArithmeticInstructionReg(unsigned char src_idx, unsigned char dest_idx) : RegisterInstruction(dest_idx), srcRegisterIndex(src_idx) {}
  };

  class AddArithmeticInstructionReg : public ArithmeticInstructionReg {
    public:

      AddArithmeticInstructionReg(unsigned char src_idx, unsigned char dest_idx) : ArithmeticInstructionReg(src_idx, dest_idx) {}

      void eval(EmulatorState& st) override {
          assert(0 <= destRegisterIndex && destRegisterIndex <= 3 && 0 <= srcRegisterIndex && srcRegisterIndex <= 3);
  ...
  class SubArithmeticInstructionReg : public ArithmeticInstructionReg {
    public:
      ...
      SubArithmeticInstructionReg(unsigned char src_idx, unsigned char dest_idx) : ArithmeticInstructionReg(src_idx, dest_idx) {}
  ...
  class MulArithmeticInstructionReg : public ArithmeticInstructionReg {
    public:
      ...
      MulArithmeticInstructionReg(unsigned char src_idx, unsigned char dest_idx) : ArithmeticInstructionReg(src_idx, dest_idx) {}
  ...
  class DivArithmeticInstructionReg : public ArithmeticInstructionReg {
    public:
      ...
      DivArithmeticInstructionReg(unsigned char src_idx, unsigned char dest_idx) : ArithmeticInstructionReg(src_idx, dest_idx) {}
  ...
  class ArithmeticInstructionImm : public RegisterInstruction {
    ...
    public:
      ...
      ArithmeticInstructionImm(int immediate , unsigned char idx) : RegisterInstruction(idx), imm(immediate)  {}
  ...
  class AddArithmeticInstructionImm : public ArithmeticInstructionImm {
    public:
      ...
      AddArithmeticInstructionImm(unsigned short address, unsigned char idx) : ArithmeticInstructionImm(address, idx) {}
  ...
  class SubArithmeticInstructionImm : public ArithmeticInstructionImm {
    public:
      ...
      SubArithmeticInstructionImm(unsigned short address, unsigned char idx) : ArithmeticInstructionImm(address, idx) {}
  ...
  class MulArithmeticInstructionImm : public ArithmeticInstructionImm {
    public:
      ...
      MulArithmeticInstructionImm(unsigned short address, unsigned char idx) : ArithmeticInstructionImm(address, idx) {}
  ...
  class DivArithmeticInstructionImm : public ArithmeticInstructionImm {
    public:
      ...
      DivArithmeticInstructionImm(unsigned short address, unsigned char idx) : ArithmeticInstructionImm(address, idx) {}
  ...
  class MovInstructionReg : public RegisterInstruction {
    ...
    public:
       ...
       MovInstructionReg(unsigned char src_idx, unsigned char dest_idx) : RegisterInstruction(dest_idx), srcRegisterIndex(src_idx) {}
  ...
  class MovInstructionImm : public RegisterInstruction {
    ...
    public:
       ...
       MovInstructionImm(int immediate, unsigned char dest_idx) : RegisterInstruction(dest_idx), imm(immediate) {}
  ...
  class LoadInstruction : public RegisterInstruction {
    ...
    public:
      ...
      LoadInstruction(unsigned char dest_idx, unsigned short address) : RegisterInstruction(dest_idx), srcRAMAddress(address) {}

      void eval(EmulatorState& st) override {
          assert(0 <= destRegisterIndex && destRegisterIndex <= 3 && 0 <= srcRAMAddress && srcRAMAddress <= 1023);
  ...
  class StoreInstruction : public Instruction {
    ...
    public:
      ...
      StoreInstruction(unsigned short address, unsigned char idx) : destRAMAddress(address), srcRegisterIndex(idx) {}

      void eval(EmulatorState& st) override {
          assert(0 <= destRAMAddress && destRAMAddress <= 1023 && 0 <= srcRegisterIndex && srcRegisterIndex <= 3);
  ...
  Instruction* buildArithmeticInstr(std::smatch match) {
      if (match[2].matched) {
          if (match[8].matched) {
             return new AddArithmeticInstructionReg(std::stoi(match[8]), std::stoi(match[6]));
          } else {
             return new AddArithmeticInstructionImm(std::stoi(match[9]), std::stoi(match[6]));
          } 
      } else if (match[3].matched) {
          if (match[8].matched) {
             return new SubArithmeticInstructionReg(std::stoi(match[8]), std::stoi(match[6]));
          } else {
              return new SubArithmeticInstructionImm(std::stoi(match[9]), std::stoi(match[6]));
          }
      } else if (match[4].matched) {
          if (match[8].matched) {
              return new MulArithmeticInstructionReg(std::stoi(match[8]), std::stoi(match[6]));
          } else {
              return new MulArithmeticInstructionImm(std::stoi(match[9]), std::stoi(match[6]));
          }
      } else {
          if (match[8].matched) {
              return new DivArithmeticInstructionReg(std::stoi(match[8]), std::stoi(match[6]));
          } else {
              return new DivArithmeticInstructionImm(std::stoi(match[9]), std::stoi(match[6]));
          }
      }
  }
  ...
  const std::regex regexes[] = {std::regex("Mov R(\\d) (R(\\d)|(\\d+))"), std::regex("((Add)|(Sub)|(Mul)|(Div)) R(\\d+) (R(\\d)|(\\d+))"), std::regex("((Load)|(Store)) R(\\d) (\\d+)"), std::regex("((Jmp)|(Jmpz)) (\\d+)")};
